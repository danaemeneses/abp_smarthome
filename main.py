...
def main():
    while True:
        ...
        if opcion == "1":
            dispositivos = devices.listar_dispositivos()
            if not dispositivos: 
            ...
            dispositivo = devices.buscar_dispositivo(nombre)
            if dispositivo:
            ...
            nuevo_dispositivo = devices.agregar_dispositivo(nombre, tipo, estado)
            print(nuevo_dispositivo)

        elif opcion == "4":
            nombre_original = input("Nombre del dispositivo que quieres editar: ")
            dispositivo = devices.buscar_dispositivo(nombre_original)
            ...
            dispositivo_actualizado = devices.editar_dispositivo(nombre_original, nuevo_nombre, nuevo_tipo, nuevo_estado)
            print(dispositivo_actualizado)
        
        elif opcion == "5":
            nombre = input("Nombre del dispositivo a eliminar: ")
            dispositivo_eliminado = devices.eliminar_dispositivo(nombre)
            ...
            automatizaciones = automation.listar_automatizaciones()
            ...
            modo_automatizacion = input("Nombre modo de la automatización que quiere activar: ")
            automatizacion = automation.activar_automatizacion(modo_automatizacion)
